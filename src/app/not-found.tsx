    ...
    <div className="relative overflow-x-clip">
      ...
      <main className="relative z-10 pb-16 sm:pb-20">
        <section className="section-shell pt-16 sm:pt-24 lg:pt-32">
          <p className="mono text-sm uppercase tracking-[0.32em] text-gold-200/80">404</p>
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {QUICK_LINKS.map((link) => (
              <Link
                className="panel group rounded-[1.8rem] p-6 transition hover:-translate-y-1 hover:border-gold-300/30"
                href={link.href}
                key={link.href}
              >
                ...
                <p className="mt-5 text-sm text-gold-200 transition group-hover:translate-x-1">
                  Go →
                </p>
              </Link>
            ))}

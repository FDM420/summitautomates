  ...
  return (
    <section className="section-shell py-20 sm:py-24" id="impact">
      <div className="mx-auto flex max-w-3xl flex-col items-center gap-5 text-center">
        ...
        <div className="mt-2 inline-flex gap-1 rounded-full border border-white/10 bg-white/5 p-1">
      ...
      <div className="mt-12 grid gap-6 lg:grid-cols-2">
        {(view === "before" || view === "both") && (
          ...
          >
            <div className="flex items-center gap-3">
              <span className="grid h-10 w-10 place-items-center rounded-full border border-amber-300/30 bg-amber-300/10 text-amber-200">
                <XCircle className="h-5 w-5" />
              </span>
              <h3 className="text-xl font-semibold text-white">{BEFORE.label}</h3>
            </div>
        ...
        {(view === "after" || view === "both") && (
          ...
          >
            <div className="flex items-center gap-3">
              <span className="grid h-10 w-10 place-items-center rounded-full border border-emerald-300/30 bg-emerald-300/10 text-emerald-200">
                <CheckCircle2 className="h-5 w-5" />
              </span>
              <h3 className="text-xl font-semibold text-white">{AFTER.label}</h3>
            </div>
            <ul className="flex flex-col gap-3">

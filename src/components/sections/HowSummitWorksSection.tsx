  ...
  return (
    <section className="section-shell py-20 sm:py-24" id="how">
      ...
      <div className="relative mt-14">
        <div className="pointer-events-none absolute left-0 right-0 top-12 hidden h-px bg-gradient-to-r from-transparent via-gold-300/40 to-transparent lg:block" />
        <ol className="grid gap-6 sm:grid-cols-2 lg:grid-cols-5">
          {STEPS.map((step, i) => (
            ...
            >
              <div className="glass-card flex h-full flex-col gap-4 p-6" data-accent="gold" style={{ borderRadius: "1.5rem" }}>
                <div className="flex items-center gap-3">
                  <span className="grid h-10 w-10 place-items-center rounded-full border border-white/15 bg-white/5 text-gold-200">
